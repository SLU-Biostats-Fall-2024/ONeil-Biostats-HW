...
Observing with the strucutre commands shows me that i have a DF with 60 rows one character variable and two numeric variables

Also looking at the treatment variable, it looks categorical, lets fix it
...
Our predictor variable type is: Treatment is categorical

Our response variable type is: Growth rate is continuous

Therefore our statistical method is: anova test
