...
The kip tract and Donnerville have higher patterns of SOM than Degrasse and Hammond, but it looks like a normal distribution. 
...
```{r}
ggplot(SOM, aes(x= Forest, y= mean_SOM)) + geom_boxplot() + geom_point(size = 4, colour = "lightblue", alpha = .5) + xlab("Forest name") + ylab("Percent soil organic matter") + theme_bw()
